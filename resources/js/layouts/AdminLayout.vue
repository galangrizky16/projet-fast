...
const { rolePrefix: roleNavPrefix, roleSlug: userSlug } = useRolePrefix();
            ...
            items: [
                {
                    key: 'dashboard',
                    label: 'Dashboard',
                    href: `${roleNavPrefix.value}/dashboard`,
            ...
            items: [
                {
                    key: 'letters.create',
                    label: 'Buat Surat',
                    href: `${roleNavPrefix.value}/surat/create`,
                    icon: FilePlus2,
                },
                {
                    key: 'letters.index',
                    label: 'Semua Pengajuan',
                    href: `${roleNavPrefix.value}/surat`,
                    icon: ClipboardList,
                ...
                },
                {
                    key: 'history',
                    label: 'Riwayat Surat',
                    href: `${roleNavPrefix.value}/history`,
                    icon: History,
                },
                {
                    key: 'archive',
                    label: 'Arsip & Unduh',
                    href: `${roleNavPrefix.value}/archive`,
                    icon: Archive,
                },
            ],
        });
            ...
            items: [
                {
                    ...
                    href: `${roleNavPrefix.value}/templates`,
                    icon: FileCode2,
                },
                {
                    key: 'categories',
                    label: 'Kategori Surat',
                    href: `${roleNavPrefix.value}/categories`,
                    icon: Tag,
                },
                {
                    key: 'qr',
                    label: 'Kelola QR Code',
                    href: `${roleNavPrefix.value}/qr`,
                    icon: QrCode,
                },
            ],
        });
...
<template>
    ...
    <div class="flex h-screen overflow-hidden bg-slate-50 font-sans">
        ...
        >
            ...
            >
                <div
                    class="grid size-8 shrink-0 place-items-center rounded-lg bg-emerald-600 text-white shadow-sm"
                >
            ...
            <div class="shrink-0 px-2 pt-3">
                ...
                >
                    <div
                        class="grid size-7 shrink-0 place-items-center rounded-lg bg-emerald-100 text-[11px] font-bold text-emerald-700"
                    >
                        {{ userInitials }}
                    </div>
            ...
            <nav class="flex-1 overflow-x-hidden overflow-y-auto px-2 py-2">
                <template v-for="group in navGroups" :key="group.title">
                    <p
                        ...
                        class="mt-3 mb-1 px-2 text-[10px] font-semibold tracking-widest text-slate-400 uppercase first:mt-1"
                    >
                        {{ group.title }}
                    </p>
                    <div
        ...
        <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <div class="shrink-0">
                <Transition name="flash">
                    <div
                        v-if="flashSuccess"
                        class="mx-4 mt-3 flex items-center gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-2.5"
                    >
                        <div
                            class="flex size-5 shrink-0 items-center justify-center rounded-full bg-emerald-500"
                        >
                            <svg
